...
public class Chess {
    ...
    public static final String WHILE_K = "WK";
    public static final String WHILE_L = "WL";
    public static final String WHILE_M = "WM";
    public static final String BLACK_O = "BO";
    public static final String BLACK_P = "BP";
    public static final String BLACK_Q = "BQ";
    private int x;
    private int y;
    private String type;
